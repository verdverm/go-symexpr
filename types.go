...
func (u *PowF) Clone() Expr     {
  var base Expr
  if u.Base  != nil { base = u.Base.Clone() }
...
func (n *PowE) Clone() Expr     {
  var base,pow Expr
  if n.Base  != nil { base = n.Base.Clone() }
  if n.Power != nil { pow  = n.Power.Clone() }
...
func (n *Div) Clone() Expr      {
  var N,D Expr
  if n.Numer != nil { N = n.Numer.Clone() }
  if n.Denom != nil { D = n.Denom.Clone() }
  return NewDiv(N,D)
}
